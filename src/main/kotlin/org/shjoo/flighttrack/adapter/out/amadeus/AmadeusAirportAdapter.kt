...
import org.shjoo.flighttrack.adapter.out.amadeus.dto.AmadeusLocationResponse
...
@Component
class AmadeusAirportAdapter(
    private val amadeusWebClient: WebClient,
    private val amadeusAuthAdapter: AmadeusAuthAdapter
) : AirportSearchPort, AirportCoordinatePort {

    private val log = LoggerFactory.getLogger(AmadeusAirportAdapter::class.java)
    ...
    override fun findNearestAirport(lat: Double, lng: Double): Pair<String, Pair<Double, Double>>? {
